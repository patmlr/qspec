...
def example(n=None):
    ...
    if 0 in n:
        ...
        e_el = qs.e_el(U, q)  # The potential energy difference corresponding to the voltage (eV)
        ...
        beta = qs.beta(v)  # The relative velocity of the carbon ions.
    ...
    if 1 in n:
        ...
        f_atom = qs.absolute(f_vec_atom[:, 1:], axis=-1)
    ...
    if 3 in n:
        ...
        dr2, dr2_d = qs.delta_r2(barrett, barrett_d, barrett[-1], barrett_d[-1], delta_barret, delta_barret_d, v2, v2)
        dr4, dr4_d = qs.delta_r2(barrett, barrett_d, barrett[-1], barrett_d[-1], delta_barret, delta_barret_d, v4, v4)
        dr6, dr6_d = qs.delta_r2(barrett, barrett_d, barrett[-1], barrett_d[-1], delta_barret, delta_barret_d, v6, v6)
