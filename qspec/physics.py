...
def hyper_zeeman_num(i: float, j: float, g_n: float, g_j: float, a_hyper: array_like, b_hyper: array_like,
                     b: array_like, g_n_as_gyro: bool = False, as_freq: bool = True):
    """
    ...
    :param g_n_as_gyro: Whether g_n is the nuclear g-factor or the gyromagnetic ratio.
    :param as_freq: The shift can be returned in energy or frequency units.
    :returns: (e_eig, f_list, m_list) Lists of the eigenvalues of the Hamiltonian sorted according to the
     F and m quantum numbers returned as the second and third argument.
    """
    ...
    h_list = [np.array([[_hyper_zeeman_ij(_mi0, _mj0, _mi1, _mj1, i, j, g_i, g_j, a_hyper, b_hyper, b)
